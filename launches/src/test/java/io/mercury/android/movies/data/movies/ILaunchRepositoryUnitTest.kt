...
class ILaunchRepositoryUnitTest {
    ...
    private lateinit var launchSummary: PagedLaunchSummaryDto
    private lateinit var launch: PagedLaunchDto
    ...
    fun GetUpcomingLaunches_OffsetNull_NullOffsetUsed() {
        val offset: Int? = null
        val backendFlowable = Single.error<PagedLaunchSummaryDto>(Exception())
    ...
    fun GetLaunch_IdUsedCorrectly() {
        val id = 1
        val backendFlowable = Single.error<PagedLaunchDto>(Exception())
